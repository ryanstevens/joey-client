...
class Plaid extends Component {
  render() {
    ...
    return <WebView
      ...
      // without this the webview would blowup
      // when users did things like reset password. 
      // The following snippet from https://github.com/facebook/react-native/issues/10865 
      // seemed to fix it. 
